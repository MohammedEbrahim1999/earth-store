...
const PostCardV5Details = () => {
    ...
    return (
        <div className="up">
            <div className="son">
                <div className="serch">
                    <img src="/imgs/PostcardV5-min.jpg" alt="PostCardV1" width={570} />
                    <button className="icon-search1"></button>
                </div>
                <div className="content">
                    <p className='first'> Home / PostCard / PostCard V5</p>
...
export default PostCardV5Details;
