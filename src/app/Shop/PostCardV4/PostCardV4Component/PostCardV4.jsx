...
const PostCardV4Details = () => {
    ...
    return (
        <div className="up">
            <div className="son">
                <div className="serch">
                    <img src="/imgs/PostcardV4-min.jpg" alt="PostCardV1" width={570} />
                    <button className="icon-search1"></button>
                </div>
                <div className="content">
                    <p className='first'> Home / PostCard / PostCard V4</p>
                    <p className='second'> PostCard </p>
                    <h3> PostCard V4 </h3>
                    <p className='third'>$23.99 </p>
...
export default PostCardV4Details;
