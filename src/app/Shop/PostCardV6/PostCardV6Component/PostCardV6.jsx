...
const PostCardV6Details = () => {
    ...
    return (
        <div className="up">
            <div className="son">
                <div className="serch">
                    <img src="/imgs/PostcardV6-min.jpg" alt="PostCardV1" width={570} />
                    <button className="icon-search1"></button>
                </div>
                <div className="content">
                    <p className='first'> Home / PostCard / PostCard V6</p>
...
export default PostCardV6Details;
