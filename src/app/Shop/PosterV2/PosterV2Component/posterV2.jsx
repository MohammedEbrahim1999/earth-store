...
const PosterV2Details = () => {
    ...
    return (
        <div className="up">
            <div className="son">
                <div className="serch">
                    <img src="/imgs/PosterV2-min.jpg" alt="PosterV1" width={570} />
                    <button className="icon-search1"></button>
                </div>
                <div className="content">
                    <p className='first'> Home / Posters / Poster V2</p>
...
export default PosterV2Details
