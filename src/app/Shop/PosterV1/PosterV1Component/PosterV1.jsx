...
const PosterV1Details = () => {
    ...
    return (
        <div className="up">
            <div className="son">
                <div className="serch">
                    <img src="/imgs/Poster1.jpg" alt="PosterV1" width={570} />
                    <button className="icon-search1"></button>
                </div>
                <div className="content">
                    <p className='first'> Home / Posters / Poster V1</p>
...
export default PosterV1Details
