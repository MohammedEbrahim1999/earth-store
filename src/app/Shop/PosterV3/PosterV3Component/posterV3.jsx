...
const PosterV3Details = () => {
    ...
    return (
        <div className="up">
            <div className="son">
                <div className="serch">
                    <img src="/imgs/Poster3-min.jpg" alt="PosterV1" width={570} />
                    <button className="icon-search1"></button>
                </div>
                <div className="content">
                    <p className='first'> Home / Posters / Poster V3</p>
...
export default PosterV3Details
